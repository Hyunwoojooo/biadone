...
import { runActiveAttentionDecisionEvaluation } from "../src/evaluation/activeAttentionDecisionEvaluation";
...
if (
  ...
  throw new TypeError("Active Attention record artifact hash is incoherent.");
}
...
if (relative(process.cwd(), recordPath) !== artifactDescriptor.relativePath) {
  throw new TypeError("Active Attention record artifact path is incoherent.");
}
