# blabase Parser / MockExtractor 수정사항 정리

## 문서 목적

이 문서는 최근 blabase GPT Audit 샘플 검수에서 반복적으로 발견된 문제를 바탕으로, `Parser / Normalizer / MockExtractor / UI Review Queue`에 반영해야 할 수정사항을 정리한 문서다.
...
이 수정이 적용되면 blabase의 Sprint 3 MockExtractor는 완벽한 의미 분석은 아니더라도, 검수 가능한 70점짜리 구조화 결과에 훨씬 가까워질 수 있다.
