...
export function AtlasDashboard() {
  ...
  function writeDragPayload(
    ...
    event.dataTransfer.setData("application/x-blabase-atlas", value);
    event.dataTransfer.setData("text/plain", value);
  }

  function readDropPayload(event: ReactDragEvent<HTMLElement>) {
    const raw =
      event.dataTransfer.getData("application/x-blabase-atlas") ||
      ...
      <header className={styles.topbar}>
        <div className={styles.brand}>
          ...
          <div className={styles.brandText}>
            <div className={styles.eyebrow}>blabase · Conversation Atlas</div>
